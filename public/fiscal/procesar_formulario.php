...
$importe_recargo= ($contribucionH + $actualizacion ) * $factorRecargo; 
$importe_total = $contribucionH + $actualizacion + $importe_recargo;
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>' . "$" . number_format($importe_recargo,2) . '</td>
        </tr>
        <tr>
