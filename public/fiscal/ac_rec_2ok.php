...
<table frame="none" rules="none">
   ...
   <div class="custom-button-group">
        <button  class="btn btn-primary btn-sm" id="buscarBtn">Calcular</button>
        <button  class="btn btn-primary btn-sm"id="limpiarBtn">Limpiars</button>
        
        <button class="btn btn-primary btn-sm"  onclick="window.location.href='../menu.php'">Volver</button>
